...
public class MBAClassStudent {
    ...
    //To demonstrate this()
    public MBAClassStudent() {
        System.out.println("JVM is calling me");
    }

    //To demonstrate this()
    public MBAClassStudent(int id) {
    ...
    public MBAClassStudent(int id, String studentName) {
    ...
    public MBAClassStudent(int id, String name, String department) {
        this.id = id;
        this.name = name;
    ...
    public MBAClassStudent(int id, String name, String department, String currentYearExamDate) {
        this.id = id;
        this.name = name;
        this.department = department;
    ...
    private void getMBAStudentDetails() {
